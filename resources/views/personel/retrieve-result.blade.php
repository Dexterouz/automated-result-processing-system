...
<section class="section">
    <div class="section-header">
        <h1>Retrieve Result</h1>
        <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{ route('personel.dashboard') }}">Dashboard</a></div>
        <div class="breadcrumb-item">Retrieve Result</div>
        </div>
    </div>
    <div class="section-body">
    <h2 class="section-title">Welcome, {{ ucfirst(auth('personel')->user()->first_name) }}!</h2>
    <p class="section-lead">Fetch all result for each level, session and semester</p>

    @if (!isset($results))
    <div class="row">
        <div class="col-12">
            <form action="{{ route('personel.retrieve.result') }}" method="post">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
