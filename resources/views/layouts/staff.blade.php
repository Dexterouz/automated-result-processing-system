            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('staff.profile') }}" class="dropdown-item has-icon"><i class="far fa-user"></i> Profile</a>
                        <a href="features-settings.html" class="dropdown-item has-icon"><i class="fas fa-cog"></i> Settings</a>
                        <div class="dropdown-divider"></div>
                        <a href="{{ route('staff.logout') }}" class="dropdown-item has-icon text-danger"><i class="fas fa-sign-out-alt"></i> Logout</a>
                    </div>
                </li>
            </ul>
        </nav>
            ...
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="{{ request()->routeIs('staff.profile') ? 'active' : '' }}">
                        <a href="{{ route('staff.profile') }}" class="nav-link"><i class="fas fa-user"></i><span>Profile</span></a>
                    </li>
                    <li class="{{ request()->routeIs('staff.students') ? 'active' : '' }}">
                        <a href="{{ route('staff.students') }}" class="nav-link"><i class="fas fa-user-graduate"></i><span>Students</span></a>
                    </li>
                    <li class="{{ request()->routeIs('staff.courses') ? 'active' : '' }}">
                        <a href="{{ route('staff.courses') }}" class="nav-link"><i class="fas fa-clipboard-check"></i><span>View Courses</span></a>
                    </li>
                    <li class="{{ request()->routeIs('staff.manage.result') ? 'active' : '' }}">
                        <a href="{{ route('staff.manage.result') }}" class="nav-link"><i class="fas fa-clipboard-check"></i><span>Manage Result</span></a>
                    </li>
                    <li class="{{ request()->routeIs('staff.setting') ? 'active' : '' }}">
                        <a href="{{ route('staff.setting') }}" class="nav-link"><i class="fas fa-cog"></i><span>Settings</span></a>
                    </li>
                </ul>
            </aside>
        </div>
